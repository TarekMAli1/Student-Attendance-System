...
public class DATABASE {
    ...
    /**
     * ***********************************Search instructor groups for
     * publishing course time and day ***********************************
     */
    ...
    public ArrayList<String> _getCourses(ArrayList<String> coursearr) throws SQLException {
        ...
        try {
            ...
            getResultsOnQuery(myStatement, coursearr);
            return coursearr;
        } catch (SQLException x) {
            System.out.println("can't create result as " + x);
            return coursearr;
    ...
    public void getResultsOnQuery(Statement myStatement, ArrayList<String> coursearr) throws SQLException {
    ...
    /**
     * ************************************insert instructor data for file of
     * instructor ************************************************
     */
    ...
    /**
     * ************************************insert data of publishing course day
     * and time ************************************************
     */
